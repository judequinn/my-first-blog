...
tinyMCE.init({
    ...
    theme_advanced_buttons1: 'formatselect,|,bold,italic,underline,|,bullist,numlist,blockquote,|,justifyleft,justifycenter,justifyright,justifyfull',
    theme_advanced_buttons2: 'undo,redo,|,link,unlink,|,image,media,charmap,|,code,|,table,grappelli_documentstructure,fullscreen,',
